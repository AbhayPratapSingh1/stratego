...
import { findMatchHanlder, handleGetSetupPieces, handleSetPieces, handleUpdates, handleUserPieceAction, loginHandler } from "./requestHanlder.js";
...
export const createApp = () => {
  ...
  app.post("/move-pieces", handleUserPieceAction)
